/**
 * Taktiksel Simülasyon (Tactical Sim) — Discord Sunucusu Otomatik Kurulum Betiği
 * 
 ...
 * 4. Terminalde çalıştırın: node create_discord_server.js
 */
...
async function runInstallation(token, guildId) {
  ...
  try {
    ...
    console.log("\n==========================================================");
    console.log("🎉 TEBRİKLER! HAREKAT MERKEZİ SUNUCUNUZ TAMAMEN KURULDU!");
    console.log("==========================================================");
